...
if __name__ == '__main__':
	...
	clf = neighbors.NearestNeighbors(n_neighbors=500, algorithm='auto')
	...
	WInt = SScombineScales(convertRFPredToImg(np.mean(dist, axis = 1), OSMatrixTest))
